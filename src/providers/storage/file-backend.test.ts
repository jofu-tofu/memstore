...
const TEST_MEMSTORE_DIR = join(homedir(), '.memstore-test-file-backend');
...
describe('FileBackend', () => {
  ...
  describe('initialize', () => {
    test('should create mem-store directory structure', async () => {
      const segmentsDir = join(TEST_MEMSTORE_DIR, 'mem-store', 'segments');
      const structuredDir = join(TEST_MEMSTORE_DIR, 'mem-store', 'structured');
