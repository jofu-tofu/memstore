...
const TEST_MEMSTORE_DIR = join(homedir(), '.memstore-test-performance-metrics');
const TEST_METRICS_DIR = join(TEST_MEMSTORE_DIR, 'mem-store', 'metrics');
